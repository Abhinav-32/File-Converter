export default function About() {
  return (
      <div className="space-y-12 text-md md:text-lg text-muted-foreground pb-4 md:pb-8">
          <p>
          A web-based file conversion web application allows users to upload files in 
          various formats (such as images, videos, documents, or audio files) and convert
          them to different formats. Users can choose the desired output format,and the 
          app processes the conversion, providing the converted file for download or 
          preview.The app’s clean interface guides users through the process, ensuring 
          ...
          <div className="space-y-2">
              ...
              <p>
                  Access FileConver from any device with an internet connection. Whether you're on your computer, tablet,
